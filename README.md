...
| Birthdays | Profile → birthdays. Calendar shows them yearly; tap for the birthday sheet: wrap a present (opens midnight their time), a hidden birthday budget, wishlists, a calendar reminder a week before, and your own wish capsule. |
| Notifications | Profile → Notifications. Bubbles, memories, comments, plans, presents, plus reminders for trips, flights, birthdays and the 23rd. Setup: `supabase/PUSH-SETUP.md`. |
